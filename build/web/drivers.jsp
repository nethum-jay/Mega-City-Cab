            ...
            <tbody>
                <%
                    ...
                    try {
                        ...
                        String query = "SELECT driver_id, name, license_number, experience, contact, availability FROM drivers";
                ...
                <tr>
                    ...
                    <% if ("manager".equals(userEmail)) { %>
                        <td>
                            <a href="editDriver.jsp?id=<%= rs.getInt("driver_id") %>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="deleteDriverServlet?id=<%= rs.getInt("driver_id") %>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this driver?')">Delete</a>
                        </td>
                    <% } %>
                </tr>
                <%
                ...
                %>
                <tr>
                    <td colspan="6" class="text-center text-danger">Error loading drivers.</td>
                </tr>
                <%
                    } finally {
