            ...
            <tbody>
                <%
                    try {
                        ...
                        String query = "SELECT b.id, b.pickup, b.dropoff, d.name AS driver, c.model AS car, " +
                                       "b.distance, b.base_fare, b.tax, b.discount, b.total_fare " +
                                       "FROM billing b " +
                ...
                <tr>
                    ...
                    <td>LKR<%= String.format("%.2f", rs.getDouble("base_fare")) %></td>
